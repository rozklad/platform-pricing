...
;(function(window, document, $, undefined)
{
	...
	Extension.Index.datePicker = function()
	{
		...
		$('.daterangepicker_start_input').attr('data-grid', 'currencieshistory');

		$('.daterangepicker_end_input').attr('data-grid', 'currencieshistory');
	...
	Extension.Index.dataGrid = function()
	{
		...
		Extension.Index.Grid = $.datagrid('currencieshistory', '#data-grid', '#data-grid_pagination', '#data-grid_applied', config);
