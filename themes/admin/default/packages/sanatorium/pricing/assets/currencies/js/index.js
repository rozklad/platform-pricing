...
;(function(window, document, $, undefined)
{
	...
	Extension.Index.datePicker = function()
	{
		...
		$('.daterangepicker_start_input').attr('data-grid', 'currency');

		$('.daterangepicker_end_input').attr('data-grid', 'currency');
	...
	Extension.Index.dataGrid = function()
	{
		...
		Extension.Index.Grid = $.datagrid('currency', '#data-grid', '#data-grid_pagination', '#data-grid_applied', config);
