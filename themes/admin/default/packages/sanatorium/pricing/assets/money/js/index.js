...
;(function(window, document, $, undefined)
{
	...
	Extension.Index.datePicker = function()
	{
		...
		$('.daterangepicker_start_input').attr('data-grid', 'money');

		$('.daterangepicker_end_input').attr('data-grid', 'money');
	...
	Extension.Index.dataGrid = function()
	{
		...
		Extension.Index.Grid = $.datagrid('money', '#data-grid', '#data-grid_pagination', '#data-grid_applied', config);
